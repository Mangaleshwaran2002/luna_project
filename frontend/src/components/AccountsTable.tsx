...
import { RotateCcwKey, Trash2 } from "lucide-react";
...
return (
  <div className="p-6 w-screen md:w-10/12">
    <h1 className="text-xl md:text-2xl font-semibold mb-2 md:mb-4">User Accounts</h1>
    ...
    {users.length > 0 ? (
      <>
        ...
        <div className="space-y-4 block md:hidden my-3">
          {users.map((user) => user.username !== 'superuser' ? (
